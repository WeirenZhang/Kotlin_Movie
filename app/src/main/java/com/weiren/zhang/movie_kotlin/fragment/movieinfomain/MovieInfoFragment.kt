...
import com.weiren.zhang.movie_kotlin.adapter.movieinfomain.MovieInfoAdapter
import com.weiren.zhang.movie_kotlin.viewmodel.movieinfomain.MovieInfoViewModel
...
@AndroidEntryPoint
@Route(path = RouterPath.MovieInfoMain.PATH_MovieInfo_HOME)
class MovieInfoFragment : BaseBindVMFragment<MovieInfoViewModel, RecyclerviewBinding>() {
    ...
    private val mAdapter: MovieInfoAdapter by lazy { MovieInfoAdapter(mActivity) }
