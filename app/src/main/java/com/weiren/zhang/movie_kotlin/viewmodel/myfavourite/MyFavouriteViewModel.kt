package com.weiren.zhang.movie_kotlin.viewmodel.myfavourite
...
@HiltViewModel
class MyFavouriteViewModel @Inject constructor(private val savedStateHandle: SavedStateHandle) :
    BaseViewModel() {

    private val HOME_PAGE_INDEX = "myfavourite_home_page_index"
